...
const Index = () => {
  return (
    <div className="min-h-screen page-transition">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-16 md:pt-40 md:pb-24 animated-gradient">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center text-center space-y-8 max-w-3xl mx-auto">
            <div className="inline-block bg-accent/10 text-accent rounded-full px-3 py-1 text-sm font-medium mb-2 animate-fade-in" style={{ animationDelay: "0.1s" }}>
            ...
            <p className="text-xl text-muted-foreground max-w-2xl animate-fade-in" style={{ animationDelay: "0.3s" }}>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <div 
                key={index} 
                className="flex flex-col items-center text-center p-6 rounded-xl hover-scale"
              >
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-8">
              <Link to="/" className="text-sm hover:text-accent button-transition">
                Home
              </Link>
              <Link to="/lobby" className="text-sm hover:text-accent button-transition">
                Lobby
              </Link>
              <Link to="/leaderboard" className="text-sm hover:text-accent button-transition">
                Leaderboard
              </Link>
            </div>
          </div>
          <div className="border-t border-gray-100 mt-8 pt-8 text-center text-sm text-muted-foreground">
